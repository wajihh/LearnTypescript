...
function findDuplicates(array: any[]): void {
    ...
    const visited: Record<string, boolean> = {}; // Object to keep track of visited elements
...
function fahrenheitToCelsius(fahrenheitTemperatures: number[]): number[] {
...
const celsiusTemperatures: number[] = fahrenheitToCelsius(fahrenheitTemperatures);
...
// Example usage
const numbers2: number[] = [4, 7, 2, 9, 5];
