...
// Dinner Guest List
const guests: string[] = ["Albert Einstein", "Marie Curie", "Ada Lovelace"];

function inviteGuest(guestName: string): void {
...
// Seeing the World
const travelList: string[] = ["Japan", "Italy", "New Zealand", "Egypt", "Iceland"];
